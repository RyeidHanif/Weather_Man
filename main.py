...
if __name__ == "__main__":
    ...
    parser.add_argument("-a", nargs='*', metavar=('YYYY/MM'), help="Monthly data in the format: YYYY/MM")
    parser.add_argument("-e", nargs='*',  metavar=('YYYY'), help="Yearly data in the format: YYYY")
    parser.add_argument("-c", nargs='*', metavar=('YYYY/MM'), help="Monthly bar chart data in the format: YYYY/MM")
    ...
    if args.a:
        try :
            for entry in args.a:
                ...
                max_temp_dict, min_temp_dict, mean_hum = computational_monthly.compute_monthly_data()
    ...
    if args.e:
        try:
            for entry2 in args.e :
                ...
                max_temp_overall_det, min_temp_overall_det, max_humidity_overall_det = compute_yearly.compute_yearly_data(yearly_data_dicts)
